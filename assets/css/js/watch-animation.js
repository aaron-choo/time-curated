(watchAnimation() {
    var now = new Date(),
        ...
        hour3Deg = (now.getHours() / 3 * 360) - 60 + now.getMinutes() / 60 * 120,
        minuteDeg = now.getMinutes() / 60 * 360 + now.getSeconds() / 60 * 6,
        negminuteDeg = -(now.getMinutes() / 60 * 360 + now.getSeconds() / 60 * 6),
        ...
        stylesDeg = [
            ...
            "@-webkit-keyframes rotate-24-hour{from{transform:rotate(" + hour24Deg + "deg);}to{transform:rotate(" + (hour24Deg + 360) + "deg);}}",
            "@-webkit-keyframes rotate-jump-hour{from{transform:rotate(" + jumphourDeg + "deg);}to{transform:rotate(" + (jumphourDeg + 360) + "deg);}}",
            "@-webkit-keyframes rotate-hour-3{from{transform:rotate(" + hour3Deg + "deg);}to{transform:rotate(" + (hour3Deg + 360) + "deg);}}",
            "@-webkit-keyframes rotate-minute{from{transform:rotate(" + minuteDeg + "deg);}to{transform:rotate(" + (minuteDeg + 360) + "deg);}}",
            "@-webkit-keyframes rotate-neg-minute{from{transform:rotate(" + negminuteDeg + "deg);}to{transform:rotate(" + (negminuteDeg - 360) + "deg);}}",
            "@-webkit-keyframes rotate-second{from{transform:rotate(" + secondDeg + "deg);}to{transform:rotate(" + (secondDeg + 360) + "deg);}}",
            "@-webkit-keyframes rotate-chrono-second{from{transform:rotate(" + 0 + "deg);}to{transform:rotate(" + (0 + 360) + "deg);}}",
            "@-webkit-keyframes rotate-chrono-split{from{transform:rotate(" + 0 + "deg);}to{transform:rotate(" + (30) + "deg);}}",
            "@-webkit-keyframes rotate-moon{from{transform:rotate(" + moonDeg + "deg);}to{transform:rotate(" + (moonDeg + 360) + "deg);}}",
            "@-webkit-keyframes rotate-date{from{transform:rotate(" + dateDeg + "deg);}to{transform:rotate(" + (dateDeg + 360) + "deg);}}",
            "@-webkit-keyframes rotate-day{from{transform:rotate(" + dayDeg + "deg);}to{transform:rotate(" + (dayDeg + 360) + "deg);}}",
            "@-webkit-keyframes rotate-month{from{transform:rotate(" + monthDeg + "deg);}to{transform:rotate(" + (monthDeg + 360) + "deg);}}",
            "@-moz-keyframes rotate-hour{from{transform:rotate(" + hourDeg + "deg);}to{transform:rotate(" + (hourDeg + 360) + "deg);}}",
            "@-moz-keyframes rotate-24-hour{from{transform:rotate(" + hour24Deg + "deg);}to{transform:rotate(" + (hour24Deg + 360) + "deg);}}",
            "@-moz-keyframes rotate-jump-hour{from{transform:rotate(" + jumphourDeg + "deg);}to{transform:rotate(" + (jumphourDeg + 360) + "deg);}}",
            "@-moz-keyframes rotate-hour-3{from{transform:rotate(" + hour3Deg + "deg);}to{transform:rotate(" + (hour3Deg + 360) + "deg);}}",
            "@-moz-keyframes rotate-minute{from{transform:rotate(" + minuteDeg + "deg);}to{transform:rotate(" + (minuteDeg + 360) + "deg);}}",
            "@-moz-keyframes rotate-neg-minute{from{transform:rotate(" + negminuteDeg + "deg);}to{transform:rotate(" + (negminuteDeg - 360) + "deg);}}",
            "@-moz-keyframes rotate-second{from{transform:rotate(" + secondDeg + "deg);}to{transform:rotate(" + (secondDeg + 360) + "deg);}}",
            "@-moz-keyframes rotate-chrono-second{from{transform:rotate(" + 0 + "deg);}to{transform:rotate(" + (0 + 360) + "deg);}}",
            "@-moz-keyframes rotate-chrono-split{from{transform:rotate(" + 0 + "deg);}to{transform:rotate(" + (30) + "deg);}}",
            "@-moz-keyframes rotate-moon{from{transform:rotate(" + moonDeg + "deg);}to{transform:rotate(" + (moonDeg + 360) + "deg);}}",
            "@-moz-keyframes rotate-date{from{transform:rotate(" + dateDeg + "deg);}to{transform:rotate(" + (dateDeg + 360) + "deg);}}",
            "@-moz-keyframes rotate-day{from{transform:rotate(" + dayDeg + "deg);}to{transform:rotate(" + (dayDeg + 360) + "deg);}}",
            "@-moz-keyframes rotate-month{from{transform:rotate(" + monthDeg + "deg);}to{transform:rotate(" + (monthDeg + 360) + "deg);}}",
